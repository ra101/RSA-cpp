...
namespace ra
{
    ...
    public:
        ...
        std::size_t sign(msg_class message);
    };
    ...
    template <typename msg_class>
    bool verify(msg_class, std::size_t, unsigned long long int);
    ...
    template <typename msg_class>
    std::size_t rsa_key_pair::sign(msg_class message)
    {
        std::hash<msg_class> hash_function;
    ...
    template <typename msg_class>
    bool verify(msg_class message, std::size_t digest, unsigned long long int others_public_key)
    {
        std::hash<msg_class> hash_function;
